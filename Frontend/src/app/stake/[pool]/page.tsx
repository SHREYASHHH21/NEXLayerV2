...
const Stake: React.FC = () => {
  ...
  const [availableBalance, setAvailableBalance] = useState<number>(889.9324);
  ...
  return (
    ...
    <BackgroundBeams/>
      ...
      />
      <div className='flex flex-col gap-12 w-full sm:h-full sm:w-4/5 mx-auto p-4  rounded-md mt-40 bg-black/30 border border-purple-600 '>
